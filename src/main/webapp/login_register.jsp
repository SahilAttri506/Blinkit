...
<html class="no-js" lang="en">
    ...
    <!-- Mirrored from htmldemo.net/mixy/mixy/login-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Apr 2023 07:47:26 GMT -->
    <head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Mixy - Organic And Food Bootstrap 5 Template </title>
        ...
        <link rel="stylesheet" href="assets/css/vendor/roadthemes-icon.css">
        <!-- Plugins Css -->
                                ...
                                <form action="#" class="account-form-box">
                                    ...
                                    <div class="checkbox-wrap mt-10">
                                        <label class="label-for-checkbox inline mt-15">
                                            <input class="input-checkbox" name="rememberme" type="checkbox" id="ememberme" value="forever"> <span>Remember me</span>
                                        </label>
                                        <a href="#" class="mt-10">Lost your password?</a>
                                    </div>
                                    <div class="button-box mt-4">
                                        <button class="btn btn--primary px-3" onclick="login()">Log in</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                            ...
                                            function register()
                                            {
                                                ...
                                                xhr.onreadystatechange = function() {
                                                    if (this.readyState === 4 && this.status === 200) {
                                                        let rsp = this.responseText;
                                                        if (rsp === "success")
                                                        {
                                                            Qual.successdb("Success", "Welcome Baby girl");
                                                        } else
                                                        {
